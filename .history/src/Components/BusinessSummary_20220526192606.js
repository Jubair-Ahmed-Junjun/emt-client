...
const BusinessSummary = () => {
  ...
  return (
    <div>
      <h1 className="text-3xl text-center uppercase pt-3">Business Summary</h1>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 justify-items-center -mt-25 mb-20">
        <div>
