          ...
          <Card.Body>
            <Card.Text>
              ...
              <p>
                ...
                <ul className="list-disc">
                  <li>
                    Do forEach loop on given products array and take and object
                    product{" "}
                  </li>
                  <li>if(product.name.includes(searchProductByName))</li>
                  <li>
                    then console or output the result. otherwise search product
