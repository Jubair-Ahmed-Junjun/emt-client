        ...
        <Card>
          ...
          <Card.Body>
            <Card.Text>
              ...
              <span className="text-info">Node Js</span> is a cross-platform and
              ...
              modules and mostly used in web development. <br /> <br />
              <span className="text-info">Javascript</span> is a Scripting
              ...
              <p>
                ...
                outside the browser with the help of NodeJS. and Javascript is
                basically used on the client-side. Node js is mostly used on the
                server-side.
              </p>
            </Card.Text>
          </Card.Body>
