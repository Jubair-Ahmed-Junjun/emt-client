...
import blog4 from "../../assets/images/testing.png";
    ...
    <div className="container mt-5">
      <>
        ...
        <Card>
          ...
          <Card.Img style={{ height: "600px" }} variant="bottom" src={blog3} />
        </Card>
        ...
        <Card className="mt-3">
          <Card.Body>
            <Card.Text>
              ...
              <p>
                <h1>
                  At first, take a variable for search like
                  searchProductByName="mobile" and think that which value has
                  given in the product array or not, and it's which if i try to
                  find from the given products array.
                </h1>
                <span>Then, i need to take or follow some steps..</span>
                <br />
                <ul className="list-none hover:list-disc">
                  ...
                  <li>
                    Apply forEach loop on given products array and take a object
                    like product{" "}
                  </li>
                  <li>
