        ...
        <Card className="mt-3">
          <Card.Body>
            <Card.Text>
              ...
              <br />
              <p>
                Think that, take a search variable search="mobile" which given
                in the product array,and it's which i try to find from given
                array. Then, i need to some steps 1. Do forEach loop on given
                products array and take and object product 2.
                if(product.name.includes(search)) 3. then console or output the
                result. otherwise search product not present in the given array.
              </p>
            </Card.Text>
          </Card.Body>
        </Card>
