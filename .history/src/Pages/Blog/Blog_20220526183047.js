    ...
    <div className="container mt-5">
      <>
        ...
        <Card className="mt-3">
          ...
          <p>
            Think that, take a search variable search="mobile" which given in
            the product array,and it's which i try to find from given array.
            Then, i need to some steps 1. Do forEach loop on given products
            array and take and object product 2.
