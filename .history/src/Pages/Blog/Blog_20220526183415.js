          ...
          <Card.Body>
            <Card.Text>
              ...
              <p>
                ...
                <span>
                  Then, i need to some steps 1. Do forEach loop on given
                </span>
                products array and take and object product 2.
                if(product.name.includes(searchProductByName)) 3. then console
                or output the result. otherwise search product not present in
                the given array.
              </p>
            </Card.Text>
          </Card.Body>
