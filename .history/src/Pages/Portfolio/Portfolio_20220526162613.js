...
const Portfolio = () => {
  return (
    <div className="h-screen">
      <h1 className="text-3xl font-bold my-12 text-center">Portfolio</h1>
      <div className="overflow-x-auto mx-24">
        <table className="table table-compact w-full">
          <thead>
            <tr>
              <th className="py-5">Info Type</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a
                  ...
                  href="jubair.ahmed.junjun@gmail.com"
                >
            ...
            <tr>
              <td className="font-bold">Contact Address</td>
              <td>
            ...
            <tr>
              <td className="font-bold">Linkedin Profile</td>
              <td>
                <a
                  className="link link-primary no-underline text-xl font-bold"
            ...
            <tr>
              <td className="font-bold">Projects</td>
              <td>
                <ul className="list-disc text-xl font-bold">
                  <li>
                    <a
            ...
            <tr>
              <td className="font-bold">Technologies </td>
              <td>
